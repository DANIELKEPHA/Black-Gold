...
export const sampleBooks = [
  {
    id: 1,
    title: "Pure, Authentic, Exceptional",
    author: "Catalog",
    genre: "M1, M2, M3, S1",
    rating: 4.6,
    totalCopies: 12,
    availableCopies: 4,
    description:
      "Our premium East African teas are sourced from top gardens, providing a sensory delight with a perfect blend of flavor, quality, and authenticity.",
    color: "#1c1f40",
  ...
  },
  {
    ...
    color: "#fffdf6",
    cover:
      "https://tse2.mm.bing.net/th?id=OIP.XngDHahgw_QFwQ8yCSy79wHaE8&pid=Api",
    video: "/sample-video.mp4?updatedAt=1722593504152",
    summary:
      "A revolutionary guide to making good habits, breaking bad ones, and getting 1% better every day.",
  },
